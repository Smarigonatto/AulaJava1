...
public class PrincipioDeSegregacaoDeInterfaces {
    ...
    public static void executarRefatorado() {
        ContaCorrenteRefatorada contaCorrenteRefatorada = new ContaCorrenteRefatorada("0001", "TESTE 1");
        ContaPoupancaRefatorada contaPoupancaRefatorada = new ContaPoupancaRefatorada("0002", "TESTE 2");
        ContaInvestimento contaInvestimento = new ContaInvestimento("0003", "TESTE 3");

        contaCorrenteRefatorada.creditar(1000.00);
        contaPoupancaRefatorada.debitar(55.70);

        contaPoupancaRefatorada.creditar(300.00);
        contaPoupancaRefatorada.creditar(13.50);
